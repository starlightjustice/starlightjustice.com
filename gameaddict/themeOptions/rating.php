...
{
add_meta_box( 'my-meta-box-id', __('Review Info', 'addict'), 'cd_meta_box_cb', 'post', 'normal', 'high' );
}
...
?>
<p>
<label for="my_meta_box_text"><b><?php _e("Over All Score", 'addict') ?></b></label>
...
<p>
<label for="creteria_1"><b><?php _e("Critera 1", 'addict') ?></b></label>
<input type="text" name="creteria_1_text" id="creteria_1_text" value="<?php echo $creteria_1_text; ?>" />
</p>
<p>
<label for="creteria_1"><b><?php _e("Critera 1 Score", 'addict') ?></b></label>
...
<p>
<label for="creteria_2"><b><?php _e("Critera 2", 'addict') ?></b></label>
<input type="text" name="creteria_2_text" id="creteria_2_text" value="<?php echo $creteria_2_text; ?>" />
</p>
<p>
<label for="creteria_2"><b><?php _e("Critera 2 Score", 'addict') ?></b></label>
...
<p>
<label for="Critera_1"><b><?php _e("Critera 3", 'addict') ?></b></label>
<input type="text" name="creteria_3_text" id="creteria_3_text" value="<?php echo $creteria_3_text; ?>" />
</p>
<p>
<label for="creteria_3"><b><?php _e("Critera 3 Score", 'addict') ?></b></label>
...
<p>
<label for="creteria_4_text"><b><?php _e("Critera 4", 'addict') ?></b></label>
<input type="text" name="creteria_4_text" id="creteria_4_text" value="<?php echo $creteria_4_text; ?>" />
</p>
<p>
<label for="creteria_4"><b><?php _e("Critera 4 Score", 'addict') ?></b></label>
...
<p>
<label for="creteria_5_text"><b><?php _e("Critera 5", 'addict') ?></b></label>
<input type="text" name="creteria_5_text" id="creteria_5_text" value="<?php echo $creteria_5_text; ?>" />
</p>
<p>
<label for="creteria_5"><b><?php _e("Critera 5 Score", 'addict') ?></b></label>
